                                ...
                                <Col span={12}>
                                    <div className="card-content">
                                        <Row className="row">
                                            <Col span={24}>
                                                <AttachButton>
                                                    <Button className="attachButton" onClick={() => handleImportData()} type="primary">
                                                        Import
                                                    </Button>
                                                </AttachButton>
                                            </Col>
                        ...
                        tableData == true ?
                            <>
                                <FormSection theme={theme}>
                                    <TableComponent theme={theme} title="Customer Details" data={bulkData} columns={columns} />
                                </FormSection>
                                <AttachButton>
                                    <Button className="attachButton" onClick={() => handleSelectedRows()} type="primary">
                                        Bulk Quote
                                    </Button>
                                </AttachButton>
                            </>
